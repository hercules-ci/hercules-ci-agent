...
```
 ...
 - `dayOfWeek`: An option list of strings representing the days during which jobs should be created. Valid items are `"Mon"`, `"Tue"`, `"Wed"`, `"Thu"`, `"Fri"`, `"Sat"`, `"Sun"`. Default: all days of the week.

 - `dayOfMonth`: A list of integers representing the days of the month during which jobs should be created. Inclusive range: `[1 .. 31]`. Default: all days of the month.
