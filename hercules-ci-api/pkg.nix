...
, exceptions, hashable, hspec, http-api-data, http-media, lens
, lens-aeson, memory, network-uri, profunctors, QuickCheck, servant
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    http-api-data http-media lens lens-aeson memory network-uri
